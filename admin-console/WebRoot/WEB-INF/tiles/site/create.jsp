...
<div id="form_container">
	...
	<form:form id="form"
		action="${pageContext.request.contextPath}/secure/site/create.do"
		...
		<div class="form_description">
			<h2>
				<fmt:message bundle="${msg}" key="site.create.title" />
			</h2>
			<p>
				<fmt:message bundle="${msg}" key="site.create.description" />
			</p>
