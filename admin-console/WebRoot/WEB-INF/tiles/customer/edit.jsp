...
<div id="form_container">
	...
	<form:form id="form"
		action="${pageContext.request.contextPath}/secure/customer/edit.do"
		...
		<div class="form_description">
			<h2>
				<fmt:message bundle="${msg}" key="customer.edit.title" />
			</h2>
			<p>
				<fmt:message bundle="${msg}" key="customer.edit.description" />
			</p>
