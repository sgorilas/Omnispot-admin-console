...
<div id="form_container">
	...
	<form:form id="form"
		action="${pageContext.request.contextPath}/secure/installation/create.do"
		...
		<div class="form_description">
			<h2>
				<fmt:message bundle="${msg}" key="installation.create.title" />
			</h2>
			<p>
				<fmt:message bundle="${msg}" key="installation.create.description" />
			</p>
